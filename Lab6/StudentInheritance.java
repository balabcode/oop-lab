...
class StudentInheritance {
    ...
    public StudentInheritance(String name, int[] marks) {
        sname = name;
        marks_array = marks;
    }
    ...
    public static void main(String[] args) {
        ...
        StudentInheritance defaultStudent = new StudentInheritance();
        ...
        scanner.close();
        StudentInheritance student = new StudentInheritance(name, marks);
        System.out.println("\nStudent Details:");
        student.display();
        System.out.println("\nMarks Computation:");
        student.compute();
...
class ScienceStudent extends StudentInheritance {
...
class ArtsStudent extends StudentInheritance {
